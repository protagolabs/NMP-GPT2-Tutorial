...
def setup_args():
    ...
    parser.add_argument('--data', default= "KATANABRAVE/stories" , type=str, required=False, help='')
...
stories = load_dataset(training_args.data)
...
def train(dataset, training_args, model, optimizer, scheduler, step_callback):
    ...
    for epoch in range(training_args.num_train_epochs):
        ...
        for train_step, batch in enumerate(train_data):
            ...
            """
            Monitor the defined metric by step_callback
            """
            monitor_metrics = {
                "loss": loss.item(),
...
"""
We turn on the ddp function for distributed training.
"""
